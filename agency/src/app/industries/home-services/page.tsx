      ...
      <section className="bg-white pt-28 pb-16 px-6 border-b border-brass-light">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <Link href="/industries" className="text-sm text-ink-light hover:text-green-700 transition">
              Industries
            </Link>
          ...
          <div className="mt-8">
            <Link
              href="/contact"
              className="inline-block bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded font-semibold text-lg transition-colors"
            >
              ...
              <div key={t.name} className="bg-canvas border-l-4 border-green-700 rounded-sm p-6">
                ...
                <ul className="space-y-1">
                  {t.capabilities.map((c) => (
                    <li key={c} className="text-xs text-ink-mid flex items-start gap-2">
      ...
      <section className="py-24 px-6 bg-green-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white leading-tight max-w-2xl">
            Find out where your business is leaving revenue on the table.
          </h2>
          <p className="mt-6 text-green-200 text-lg max-w-lg">
            Book an AI Opportunity Assessment. We&apos;ll map your call flow, workflows, and follow-up gaps — then show you exactly what we&apos;d build.
          </p>

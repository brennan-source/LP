          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={p.pillar} className={`bg-white border-l-4 ${p.accent} rounded-sm p-6`}>
                <div className={`inline-block ${p.label} text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-sm mb-3`}>
                  {p.pillar}
                </div>
      ...
      <section className="py-24 px-6 bg-green-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white leading-tight max-w-2xl">
            Ready to measure what AI actually delivers for your firm?
          </h2>

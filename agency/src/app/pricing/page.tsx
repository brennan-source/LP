...
const AI_TIERS = [
  ...
  },
  {
    ...
    priceNote: "one-time",
    badge: null,
    description: "One automation, built and running fast. Pick the single biggest time-waster in your business and we'll eliminate it. The $1,500 fee is fully credited toward Ops Core or Back Office when you're ready to build out the full stack.",
    includes: [
          ...
          <div className="mb-8 bg-stone-50 border border-stone-200 rounded-2xl p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-0">
              <div className="flex-1 text-center px-4">
                <p className="text-base font-bold text-stone-900">Start free</p>
                <p className="text-xs text-stone-400 mt-1">AI Readiness Assessment</p>
              </div>
              <div className="hidden sm:block text-stone-300 text-2xl font-light">→</div>
              <div className="flex-1 text-center px-4">
                <p className="text-base font-bold text-stone-900">Get your blueprint</p>
                <p className="text-xs text-stone-400 mt-1">AI Action Plan — $299</p>
              </div>
              <div className="hidden sm:block text-stone-300 text-2xl font-light">→</div>
              <div className="flex-1 text-center px-4">
                <p className="text-base font-bold text-stone-900">Build the system</p>
                <p className="text-xs text-stone-400 mt-1">Ops Core or Back Office</p>
              </div>
            </div>
            <div className="mt-5 text-center">
              <Link href="/contact" className="text-green-700 text-sm font-semibold hover:text-green-600 transition">Start with a free assessment →</Link>
            </div>
          </div>

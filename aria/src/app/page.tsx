...
const PRODUCTS = [
  {
    ...
    items: [
      { name: "AI Readiness Assessment", price: "$9", desc: "Full scorecard with savings calculator" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Enterprise AI Build", price: "from $25,000", desc: "Billing, finance, HR, sales, marketing + dashboard" },
    ],
  },
];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
          ...
          <div className="text-slate-500 text-sm">
            <span className="font-bold text-slate-700 text-2xl mr-1">$9</span> · free to complete · pay to unlock full report
          </div>
        </div>
      ...
      <section className="bg-slate-50 py-16">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500">From a $9 assessment to a $25K custom AI build — we meet you where you are.</p>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            { n: "4", t: "Pay $9, get your report", d: "Full scorecard + savings estimates + 3-phase roadmap." },
          ].map((s, i) => (
      ...
      <section className="bg-gradient-to-br from-violet-600 to-indigo-700 py-20 text-center text-white">
        ...
        <p className="text-violet-200 text-lg max-w-xl mx-auto mb-8">
          Take the 10-minute assessment. Get a dollar-quantified readiness score and a custom roadmap for $9.
        </p>
        ...
        <div className="mt-4 flex justify-center gap-6 text-sm text-violet-300">
          ...
          <span className="flex items-center gap-1"><CheckCircle className="w-4 h-4" />$9 to unlock full report</span>
